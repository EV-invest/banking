...
// The signed-in user's wallet: per-network balances + deposit addresses, read live
// from the hub (TigerBeetle-authoritative). The user's access token never leaves the
// BFF — it is attached to the hub gRPC call here.
