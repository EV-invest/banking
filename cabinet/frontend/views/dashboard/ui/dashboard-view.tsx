  ...
  return (
    <div className={cn(CARD, "flex flex-col gap-4 px-[22px] py-5")}>
      ...
      <div className="flex gap-[10px]">
        <Link href="/wallet/deposit" className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-main-accent-t1 px-4 py-2.5 text-[13px] font-semibold text-main-black transition-opacity hover:opacity-90">
          <ArrowDownToLine className="size-4" /> Deposit
        </Link>
        <Link href="/wallet/withdraw" className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border px-4 py-2.5 text-[13px] font-semibold text-main-mist/90 transition-colors hover:bg-foreground/[0.04]">
