    ...
    <TerminalPane area="chart">
      ...
      <TerminalPaneBody className="relative">
        ...
        {state.kind !== "ready" && (
          ...
          <p className={cn("pointer-events-none absolute inset-0 flex items-center justify-center px-6 text-center text-xs", state.kind === "failed" ? "text-destructive" : "text-ink-soft")}>
