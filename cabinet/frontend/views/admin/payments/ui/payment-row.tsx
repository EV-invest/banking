    ...
    <tr className="align-top">
      ...
      <td className="px-5 py-3 text-xs">
        ...
        {payment.consilium_id ? (
          <Link href="/consilium" className="rounded-md text-accent-debug underline-offset-2 outline-none hover:underline focus-visible:ring-2 focus-visible:ring-ring">
