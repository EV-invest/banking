...
import type { PayoutDecision, RevenuePayout } from "@/shared/contracts/governance";
...
function PayoutTerms({ payout, payloadHash }: { payout: RevenuePayout | undefined; payloadHash: string }) {
  const t = useT();
  return (
    <>
