...
// wrong person. An external end shows its rail and a shortened address here; the surfaces
// where the address is the thing being approved render it whole through `FullAddress`
// instead (docs/CONSILIUM.md, policy 13).
