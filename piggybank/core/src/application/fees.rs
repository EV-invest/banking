...
/// acknowledge (a loosening, a change not scheduled, no notice given up on yet) is a
/// conflict rather than a no-op — see [`FeePolicyChanges::acknowledge_undelivered_notices`].
